...
//     <button
//       onClick={handleClick}
//       className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-[2px]  mb-1.5 text-sm transition-all duration-200 cursor-pointer ${
//         active
...
//               }}
//               className="w-9 h-9 flex items-center justify-center rounded-xl border border-gray-600/30 hover:bg-[#252d38] transition-colors shrink-0 cursor-pointer"
//             >
//               {open ? (
    ...
    <div className="lg:hidden fixed top-0 left-0 right-0 z-40 bg-[#0a0a0a] border-b border-[#1a1a1a]">
      <div className="flex items-center justify-between px-3 h-12">
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 rounded-full bg-[#eb660f]/20 flex items-center justify-center text-[#eb660f] font-bold text-xs shrink-0">
              {(userName?.charAt(0) || "A").toUpperCase()}
            </div>
            <div className="min-w-0">
      ...
      <div className="flex-1 overflow-y-auto px-1.5 py-1.5 sidebar-scroll">
        ...
        {hasNoResults && expanded && (
          <div className="flex flex-col items-center justify-center py-8 px-3">
            ...
            <button
              onClick={() => setSearchQuery("")}
              className="mt-2 text-[10px] text-[#eb660f] hover:text-[#eb660f]/80 transition-colors underline underline-offset-2 cursor-pointer"
            >
              Clear search
            </button>
          </div>

...
//     console.log(deleteConfirmId,"hello")
//     if (deleteConfirmId) {
//       try {
...
//                            bg-[#b9fd5c] text-white  transition-all cursor-pointer"
//               >
//                 <RefreshIcon />
//                 Refresh
//               </button>
...
//                        bg-[#b9fd5c] text-black transition-all cursor-pointer"
//           >
//             <PlusIcon />
//             Create New Post
//           </button>
...
const BlogEditor = () => {
      ...
      <div className="p-2 sm:p-2 space-y-6">
        <div className="bg-[#282f35] border border-[#2a2c2f] rounded-lg overflow-hidden">
          ...
          <div className="flex flex-col items-center justify-center py-20 px-4">
            ...
            <button
              onClick={() => refetch()}
              className="px-5 py-2.5 rounded-xl text-sm font-semibold bg-[#b9fd5c] text-black
                          transition-all cursor-pointer"
            >
              Try Again
            </button>
  ...
  const renderPostsList = () => {
    ...
    const renderPostCard = (row, index) => {
      const status = getStatusInfo(row.status);
      const sNo = (page - 1) * perPage + index + 1;
      ...
      return (
        <MobileCard
          ...
          header={{
            ...
            avatarBg: "bg-[#b9fd5c]/10 text-[#b9fd5c]",
            title: row.title || "Untitled",
            subtitle: `#${sNo} • ${row.author?.name || "Unknown"} • ${formatDate(row.updatedAt)}`,
            badge: status.label,
            badgeClass: status.class,
          }}
          rows={[
    ...
    return (
      <div className="space-y-6">
        ...
        {/* Fetching indicator */}
        {isFetchingPosts && !isLoadingPosts && <Loader />}
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-[#282f35] border border-[#2a2c2f] rounded-2xl overflow-hidden">
              <div className="px-5 py-3 border-b border-[#2a2c2f] flex items-center gap-2">
                <Globe size={16} className="text-[#b9fd5c]" />
                <span className="text-white font-semibold text-sm">SEO Settings</span>
              </div>
              <div className="p-5 space-y-4">
                <div>
            ...
            <div className="bg-[#282f35] border border-[#2a2c2f] rounded-2xl overflow-hidden">
              <div className="px-5 py-3 border-b border-[#2a2c2f] flex items-center gap-2">
                <Image size={16} className="text-[#b9fd5c]" />
                <span className="text-white font-semibold text-sm">Featured Image</span>
              </div>
              <div className="p-5">
                {formData.featuredImage && (
            ...
            <div className="bg-[#282f35] border border-[#2a2c2f] rounded-2xl overflow-hidden">
              <div className="px-5 py-3 border-b border-[#2a2c2f] flex items-center gap-2">
                <Folder size={16} className="text-[#b9fd5c]" />
                <span className="text-white font-semibold text-sm">Categories</span>
              </div>
              <div className="p-5 space-y-3">
                <div className="flex gap-2">
            ...
            <div className="bg-[#282f35] border border-[#2a2c2f] rounded-2xl overflow-hidden">
              <div className="px-5 py-3 border-b border-[#2a2c2f] flex items-center gap-2">
                <CheckCircle size={16} className="text-[#b9fd5c]" />
                <span className="text-white font-semibold text-sm">Status</span>
              </div>
              <div className="p-5">
                <select
  ...
  return (
    <div className="p-2 sm:p-2">
      ...
      {/* Delete Confirmation Modal */}
     // In BlogEditor.jsx - Update the ConfirmModal usage

{/* Delete Confirmation Modal */}
<ConfirmModal
  show={showDeleteModal}  // Changed from isOpen to show
  onClose={() => {
    setShowDeleteModal(false);
    setDeleteConfirmId(null);
  }}

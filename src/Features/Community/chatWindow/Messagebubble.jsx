...
const MessageBubble = ({
  ...
  if (msg.messageType === "system" || msg.msgBody?.message_type === "system") {
    const systemText =
    ...
    return (
      <div id={`msg-${id}`} data-msg-id={id} className="flex justify-center my-2">
        <div className="px-3 py-1 rounded-full bg-[#182229] text-[14px] text-gray-400 text-center max-w-[80%]">
          {systemText}
        </div>
      </div>
    );

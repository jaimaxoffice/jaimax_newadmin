...
// //   // DB roles: 0 = admin, 2 = subadmin  
// //   // String roles: "admin", "superAdmin", "subAdmin"
// //   const isAdmin =
// //     userRole === "admin" ||
// //     userRole === "superAdmin" ||
// //     userRole === 0;
...
// //   const canDeleteForEveryone = isCurrentUser || isAdmin || isSubAdmin;
...
// //           {/* Pin / Unpin — ONLY for admin (role 0) & subadmin (role 2) */}
// //           {canPin && (
// //             <MenuItem
// //               icon={
// //                 pinned ? (
...
// //           {/* Delete for everyone — admin, subadmin, or message owner */}
...
//   // ══════════════════════════════════════════════════════════
//   //  Role-based permissions
//   //  DB roles: 0 = admin, 1 = moderator/manager, 2 = subadmin
//   //  String roles: "admin", "superAdmin", "subAdmin"
//   // ══════════════════════════════════════════════════════════

//   // Resolve numeric role from currentUser or userRole prop
//   const numericRole =
...
//   // Pin/Unpin: admin (0) + subadmin (2)
//   const canPin = isAdmin || isSubAdmin;

//   // Delete for everyone:
//   //   - Own messages: always ✅
//   //   - Others' messages: only role 0 (admin) or role 1 (moderator) ✅
//   const canDeleteForEveryone = isCurrentUser || isModeratorOrAbove;
...
//           {/* Pin / Unpin — admin (0) & subadmin (2) only */}
//           {canPin && (
//             <MenuItem
//               icon={
//                 pinned ? (
...
//           {/* Delete for everyone — own msgs OR role 0/1 for ANY msg */}
//           {canDeleteForEveryone && (
//             <MenuItem
//               icon={<Trash2 className="w-[18px] h-[18px]" />}
//               label="Delete for everyone"

        ...
        <div className="bg-[#1a1c1f] border border-[#2a2c2f] rounded-2xl p-6 sm:p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full bg-[#111214] border ${
                  errors.loginEmail
                    ? "border-red-500/50"
                    : "border-[#2a2c2f] focus:border-[#0ecb6f]"
                } text-white placeholder-[#555] rounded-xl py-3 px-4 text-sm
                  focus:outline-none focus:ring-1 focus:ring-[#0ecb6f]/50 transition-colors`}
              />
              {errors.loginEmail && (
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 pr-4 flex items-center 
                    text-[#8a8d93] hover:text-[#0ecb6f] text-xs font-medium 
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-[#0ecb6f] hover:bg-[#0ecb6f]/90 

        ...
        <div className="w-full">
          ...
          <div className="bg-[#1a2128] border border-[#2b3440] rounded-xl px-3 sm:px-4 md:px-5 pb-1 pt-4 overflow-x-hidden">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-5">
              ...
              <div className="bg-[#4c4320] rounded-xl p-4 text-white flex flex-col items-center justify-center text-center min-h-[100px]">
              ...
              {/* Total Bills */}
              <div className="bg-[#154555] rounded-xl p-4 text-white flex flex-col items-center justify-center text-center min-h-[100px]">
              ...
              {/* Upload Card */}
              <div
                className="bg-[#173632] rounded-xl p-4 text-white flex flex-col items-center justify-center text-center min-h-[100px] cursor-pointer hover:opacity-90 transition"
                    ...
                    {[
                      ...
                      <th
                        ...
                        className={`px-4 py-3 whitespace-nowrap ${
                          h === "Description"
                            ? "min-w-[250px] max-w-[300px] text-center"
                            : ""
                        }`}
                      >
                        {h}

...
//   <div
//     className={`${bgClass} rounded-xl p-5 text-white flex flex-col items-center justify-center min-h-25 transition-all duration-300 hover:-translate-y-1 hover:opacity-90`}
//   >

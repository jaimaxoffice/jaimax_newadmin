...
const DocumentUpload = ({
  ...
  return (
    <div>
      ...
      {preview ? (
        <div className="relative bg-[#111214] border border-[#0ecb6f]/30 rounded-xl p-3">
          <img
            src={preview}
            alt={label}
        ...
        <div
          ...
          className={`border-2 border-dashed rounded-xl h-40 cursor-pointer
            ...
            hover:border-[#0ecb6f]/50 hover:bg-[#0ecb6f]/5
            ${
              error
        ...
        >
          <div className="w-10 h-10 rounded-full bg-[#0ecb6f]/10 flex items-center justify-center">
            <span className="text-[#0ecb6f] text-lg">↑</span>
          </div>

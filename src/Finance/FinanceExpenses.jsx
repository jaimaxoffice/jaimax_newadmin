...
const BillViewButton = ({ url }) => {
  ...
  return (
    <a
      ...
      className="inline-flex items-center justify-center px-2.5 py-1.5 text-white  hover:bg-[#d45a0d] rounded text-xs transition"
    >
      <Eye size={14} />
    </a>
  );
...
const [debouncedEndDate, setDebouncedEndDate] = useState(endDate);
  ...
  /* ── User Data ── */
  const storedUserData = JSON.parse(Cookies.get("adminUserData") || "{}");
 ...
 const buildQueryParam = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      header: "Date of Bill",
      nowrap: true,
      render: (doc) => doc.date || "N/A",
    },
    {
      key: "name",
      header: "Name",
      nowrap: true,
      render: (doc) => doc.name || "N/A",
    },
    {
      key: "category",
      header: "Category",
    ...
    },
    {
      ...
      render: (doc) => (
        <div className="flex gap-2">
          <button
            className="p-1.5  hover:bg-[#d45a0d] text-white rounded text-xs transition"
              ...
              <Form className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className={selectWrap}>
                      {/* ✅ dynamic from DB — remove all hardcoded options */}
                      <Field name="category" as="select" className={inputCls} disabled={categoriesLoading}>
                        <option value="">
